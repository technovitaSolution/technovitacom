  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      console.log('Submitting form data:', {
        ...
        offer: 'Get Ajio Onboarding FREE with Myntra Onboarding',
        source: 'Nykaa Calculator Popup 2'
      });
            ...
            {!isSubmitted ? (
              <>
                ...
                <div className="text-center mb-4 sm:mb-6">
                  <div className="inline-flex items-center justify-center w-12 h-12 sm:w-16 sm:h-16 bg-gradient-to-r from-blue-100 to-purple-100 rounded-full mb-3 sm:mb-4">
                  ...
                  <p className="text-gray-600 text-xs sm:text-sm leading-relaxed">
                    Take Myntra seller onboarding and get Ajio onboarding absolutely FREE. Expand to both platforms with our exclusive offer!
                  </p>
                </div>
                ...
                <div className="space-y-2 sm:space-y-3 mb-4 sm:mb-6">
                  ...
                  <div className="flex items-center space-x-2 sm:space-x-3">
                    <CheckCircle className="h-4 w-4 sm:h-5 sm:w-5 text-green-500 flex-shrink-0" />
                    <span className="text-xs sm:text-sm text-gray-700">Get Ajio onboarding absolutely FREE</span>
                  </div>
                  <div className="flex items-center space-x-2 sm:space-x-3">
                    <CheckCircle className="h-4 w-4 sm:h-5 sm:w-5 text-green-500 flex-shrink-0" />
                    <span className="text-xs sm:text-sm text-gray-700">Dual platform expansion strategy</span>
                  </div>
                  <div className="flex items-center space-x-2 sm:space-x-3">
                    <CheckCircle className="h-4 w-4 sm:h-5 sm:w-5 text-green-500 flex-shrink-0" />
                    <span className="text-xs sm:text-sm text-gray-700">Expert guidance for both platforms</span>
                  </div>
                </div>
              ...
              <div className="text-center">
                ...
                <h3 className="text-xl font-bold text-gray-900 mb-2">
                  🎉 Free Ajio Onboarding Claimed!
                </h3>
                <p className="text-gray-600 text-sm">
                  Your FREE Ajio onboarding with Myntra onboarding has been claimed. 
