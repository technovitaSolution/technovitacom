          ...
          <section className="bg-white rounded-xl shadow-lg p-8 mb-12">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              <div className="bg-gray-50 p-6 rounded-lg shadow-sm">
                ...
                <p className="text-gray-700">
                  Great Service! I took their advertisement of products on Myntra services. Best thing is they were on time and provided best services.
                </p>
              </div>
              ...
              <div className="bg-gray-50 p-6 rounded-lg shadow-sm">
                ...
                <p className="text-gray-700">
                  I took their Myntra account management services, they are very professional in their work. I will highly recommend them to you.
                </p>
              </div>
              ...
              <div className="bg-gray-50 p-6 rounded-lg shadow-sm">
                ...
                <p className="text-gray-700">
                  I am a seller on Myntra. Initially my sales were not that much but after taking their account management services my sales increased by 400%(4x). They added good keywords on my Myntra seller account regarding my products. Thanks Technovita solution.
                </p>
              </div>
            </div>
          </section>
